  ...
  if (screen === 'username') {
    return (
      <div className="min-h-screen bg-gray-950 flex flex-col items-center justify-center gap-6">
        <img src="/logo.png" alt="Dles Night" className="h-16 w-auto cursor-pointer hover:opacity-75 transition-opacity" onClick={() => setScreen('menu')} />
  ...
  return (
    <div className="flex flex-col h-screen w-screen overflow-hidden bg-gray-950 text-white">
      ...
      <header className="relative flex items-center px-4 h-12 border-b border-gray-800 shrink-0">
        <img src="/logo.png" alt="Dles Night" className="h-8 w-auto cursor-pointer hover:opacity-75 transition-opacity" onClick={handleReturnToMenu} />
